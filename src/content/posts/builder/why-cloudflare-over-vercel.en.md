---
title: "Why I picked Cloudflare over Vercel for my Astro site"
tldr: "I picked Cloudflare over Vercel for my personal site because I want to add a chat tool later that lets me query my own writing, and Cloudflare has all the pieces for that built in. Vercel is still the nicer everyday experience, I use it for my other site, and would be the better call for something simpler."
description: "How a non-technical founder picked a hosting company for her personal site, and why Cloudflare turned out to be the right call."
category: "Builder"
...
My other site [in-betweens.cc](https://in-betweens.cc) runs on Vercel and I'm happy with it. Fast, easy to work with, the dashboard is polished, zero friction to deploy, and site analytics are easy to see.
